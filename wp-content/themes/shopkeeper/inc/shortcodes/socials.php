...
function shopkeeper_socials($atts, $content = null) {	
    ...
    <div class="site-social-icons-shortcode">
        <ul class="<?php echo esc_html($items_align); ?>">
            ...
            <?php if ( (isset($shopkeeper_theme_options['houzz_link'])) && (trim($shopkeeper_theme_options['houzz_link']) != "" ) ) { ?><li class="site-social-icons-houzz"><a target="_blank" href="<?php echo esc_url($shopkeeper_theme_options['houzz_link']); ?>"><i class="fa fa-houzz"></i><span>Houzz</span></a></li><?php } ?>
            <?php if ( (isset($shopkeeper_theme_options['naver_line_link'])) && (trim($shopkeeper_theme_options['naver_line_link']) != "" ) ) { ?><li class="site-social-icons-naver"><a target="_blank" href="<?php echo esc_url($shopkeeper_theme_options['naver_line_link']); ?>"><i class="spk-icon spk-icon-naver-line-logo"></i><span>VK</span></a></li><?php } ?>
            <?php if ( (isset($shopkeeper_theme_options['tripadvisor_link'])) && (trim($shopkeeper_theme_options['tripadvisor_link']) != "" ) ) { ?><li class="site-social-icons-tripadvisor"><a target="_blank" href="<?php echo esc_url($shopkeeper_theme_options['tripadvisor_link']); ?>"><i class="fa fa-tripadvisor"></i><span>TripAdvisor</span></a></li><?php } ?>
            <?php if ( (isset($shopkeeper_theme_options['wechat_link'])) && (trim($shopkeeper_theme_options['wechat_link']) != "" ) ) { ?><li class="site-social-icons-wechat"><a target="_blank" href="<?php echo esc_url($shopkeeper_theme_options['wechat_link']); ?>"><i class="fa fa-weixin"></i><span>WeChat</span></a></li><?php } ?>
        </ul>
    </div>
