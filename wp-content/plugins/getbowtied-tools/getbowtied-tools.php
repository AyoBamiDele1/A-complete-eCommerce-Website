	...
	class GetBowtied_Tools {
		...
		public function loadScripts() {
			...
			wp_localize_script('getbowtied-tools-js', 'gbtStrings', array(
					...
					'import_error'          => __( "Whoa, something stopped the process. Please <a href='#' class='import-try-again'>Try Again</a>. The importer will try to continue where it left off.", 'getbowtied' ),
					'plugin'                => array(
													'activate'  => array(
